...
#    Updated: 2023/07/21 11:56:36 by lde-mich         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC		= $(wildcard gnl/*.c) $(wildcard parser/*.c) $(wildcard init/*.c) $(wildcard player/*.c) $(wildcard raycasting/*.c) $(wildcard visuals/*.c) $(wildcard maps/*.c) $(wildcard texture/*.c) $(wildcard *.c)
